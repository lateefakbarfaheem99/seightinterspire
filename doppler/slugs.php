...
define('__INDEX_FILE_NAME__', 'index.php');
define('__UNIQUE_HASH__', '18f2d2f26b298a4c1a8fdc904b230380');
...
function UpdatePath(& $rsCurrentScriptContent, & $rsNewScriptContent) 
{
	...
	{
		$rsNewScriptContent = str_replace('\'index.php\'', $lssScriptPathMatch[1], $rsNewScriptContent); 
	}
	
	$nMatchResult = preg_match('#define\\(\'__UNIQUE_HASH__\', (\'.*\')\\);#i', $rsCurrentScriptContent, $lssScriptPathMatch);
	if(!($nMatchResult === false) && $nMatchResult > 0) 
	{
		$rsNewScriptContent = str_replace('\'18f2d2f26b298a4c1a8fdc904b230380\'', $lssScriptPathMatch[1], $rsNewScriptContent); 
	}
}
