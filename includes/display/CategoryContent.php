<?php
	...
	CLASS ISC_CATEGORYCONTENT_PANEL extends PRODUCTS_PANEL
	{
		public function SetPanelSettings()
		{
			...
			$GLOBALS['SNIPPETS']['CategoryContent'] = "";
            ...
            if($_SESSION['categoryhasauthority'][$GLOBALS['CatId']]) {
                $GLOBALS['SNIPPETS']['CategoryContent'] = $GLOBALS['ISC_CLASS_TEMPLATE']->GetSnippet("CategoryMainContent");                
            } else {
                ...
                $GLOBALS['SNIPPETS']['CategoryContent'] = $GLOBALS['ISC_CLASS_TEMPLATE']->GetSnippet("CategorySecureCheck");
            }            
		}
	}