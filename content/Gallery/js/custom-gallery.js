            $(function() {
					...
					$('<img />').load(function(){
						...
						if(loaded == nmb_images){
							...
							$albums.each(function(){
								...
								$this.stop().animate({'bottom':'0px','opacity':'100'},500);
				...
				function spreadPictures(){
					...
					$albums.not($album).stop().animate({'bottom':'-300px','opacity':'0'},300);
					$album.unbind('click');
				...
				$back.bind('click',function(){
					...
					$current_album.find('.descr:hidden').show();
					...
					$albums.not($current_album).stop().animate({'bottom':'0px','opacity':'100'},500);
				});
				...
				function showImage(nav){
					...
					$('<img style=""/>').load(function(){
						...
						var $preview = $('<div />',{
							...
							'html'     	: '<div class="pp_descr"><span>'+imgL_description+'</span></div>',//<div class="pp_descr"><span>'+imgL_description+'</span></div>
