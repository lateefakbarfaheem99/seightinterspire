			...
			$tpl->TemplateData = $tmpTplData; ?>
								...
								<td>
									...
									<select name="groupid">
										...
										<?php $array = $tpl->Get('AvailableGroups'); if(is_array($array) || is_object($array)): foreach($array as $__key=>$EachGroup): $tpl->Assign('__key', $__key, false); $tpl->Assign('EachGroup', $EachGroup, false);  ?>
