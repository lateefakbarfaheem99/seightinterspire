<?php
	...
	/**
	* This is the Australia Post shipping module for Unreal Shopping Cart. To enable
	* Australia Post in Unreal Shopping Cart login to the control panel and click the
