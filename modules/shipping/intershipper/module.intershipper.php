<?php
	...
	*/
	...
	/**
	* This is the Intershipper shipping module for Unreal Shopping Cart. To enable
	* Intershipper in Unreal Shopping Cart login to the control panel and click the
	...
	*/
	class SHIPPING_INTERSHIPPER extends ISC_SHIPPING
	{
		...
		*/
		private $_destinationtype = array();
		...
		*/
		...
		private function GetQuote()
		{
			...
			array("Version=2.0.0.0",
				...
				"TotalCarriers=" . count($this->_carriers)
				)
			);
