<?php
	...
	$GLOBALS['ISC_CFG']["ShopPath"] = "http://";
	$GLOBALS['ISC_CFG']["CharacterSet"] = "UTF-8";
	$GLOBALS['ISC_CFG']["HomePageMetaTitle"] = '';
	...
	$GLOBALS['ISC_CFG']["template"] = "default";
	...
	$GLOBALS['ISC_CFG']["AutoThumbSize"] = 120;
	...
	// QuickBooks Intergration Settings
	$GLOBALS['ISC_CFG']['QuickBooksPassword'] = '';
	$GLOBALS['ISC_CFG']['QuickBooksUsername'] = '';
	$GLOBALS['ISC_CFG']['QuickBooksFileID'] = '';
	...
	$GLOBALS['ISC_CFG']['ShowAddToCartLink'] = true;
	...
	$GLOBALS['ISC_CFG']['taxRoundingPolicy'] = 0;
	$GLOBALS['ISC_CFG']['taxPendingChanges'] = array();
	...
	$GLOBALS['ISC_CFG']['CategoryListStyle'] = 'flyout';
	$GLOBALS['ISC_CFG']['categoryFlyoutMouseOutDelay'] = 0.8;
	$GLOBALS['ISC_CFG']['categoryFlyoutDropShadow'] = false;
