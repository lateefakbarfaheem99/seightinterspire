<?php
	...
	// Last Updated: 17th Mar 2013 @ 12:02 AM
	...
	$GLOBALS['ISC_CFG']["dbUser"] = 'sei22675_seispir';
	$GLOBALS['ISC_CFG']["dbPass"] = 'seight123';
	$GLOBALS['ISC_CFG']["dbDatabase"] = 'sei22675_seightinterspire';
	$GLOBALS['ISC_CFG']["tablePrefix"] = 'isc_';
	$GLOBALS['ISC_CFG']["StoreName"] = 'Seight Custom Cycling Wear';
	$GLOBALS['ISC_CFG']["StoreAddress"] = '1 Barina Rd
Glen Iris
Victoria
3126
Australia';
	...
	$GLOBALS['ISC_CFG']["ShopPath"] = 'http://www.seightcustom.com.au';
	$GLOBALS['ISC_CFG']["CharacterSet"] = 'UTF-8';
	$GLOBALS['ISC_CFG']["HomePagePageTitle"] = 'Seight Custom Cycling Wear';
	...
	$GLOBALS['ISC_CFG']["template"] = 'Seight';
	$GLOBALS['ISC_CFG']["SiteColor"] = 'black';
	...
	$GLOBALS['ISC_CFG']["InstallDate"] = 1336182724;
	...
	$GLOBALS['ISC_CFG']["ExtendedDisplayDateFormat"] = 'jS M Y';
	...
	$GLOBALS['ISC_CFG']["AdminEmail"] = 'Tristan@seightcustom.com.au';
	$GLOBALS['ISC_CFG']["OrderEmail"] = 'cyclingwear@seightcustom.com.au';
	...
	// Shipping Settings
	$GLOBALS['ISC_CFG']["CompanyName"] = 'Seight Custom Cycling Wear';
	$GLOBALS['ISC_CFG']["CompanyAddress"] = '1 Barina Rd';
	$GLOBALS['ISC_CFG']["CompanyCity"] = 'Glen Iris';
	$GLOBALS['ISC_CFG']["CompanyCountry"] = 'Australia';
	$GLOBALS['ISC_CFG']["CompanyState"] = 'Victoria';
	$GLOBALS['ISC_CFG']["CompanyZip"] = '3146';

	// Checkout Settings
	$GLOBALS['ISC_CFG']["CheckoutMethods"] = 'checkout_nab';
	$GLOBALS['ISC_CFG']['CheckoutType'] = 'single';
	$GLOBALS['ISC_CFG']['GuestCheckoutEnabled'] = 0;
	$GLOBALS['ISC_CFG']['GuestCheckoutCreateAccounts'] = 0;

	$GLOBALS['ISC_CFG']["EmailIntegrationMethods"] = 'emailintegration_emailmarketer';
	...
	$GLOBALS['ISC_CFG']['ProductBreadcrumbs'] = 'showone';
	$GLOBALS['ISC_CFG']['FastCartAction'] = 'cart';
	...
	$GLOBALS['ISC_CFG']['BackupsLocal'] = 0;
	$GLOBALS['ISC_CFG']['BackupsRemoteFTP'] = 1;
	$GLOBALS['ISC_CFG']['BackupsRemoteFTPHost'] = 'seightcustom.com.au';
	$GLOBALS['ISC_CFG']['BackupsRemoteFTPUser'] = 'waseem@seightcustom.com.au';
	$GLOBALS['ISC_CFG']['BackupsRemoteFTPPass'] = 'waseemftp123';
	$GLOBALS['ISC_CFG']['BackupsRemoteFTPPath'] = '/auto_backups';
	$GLOBALS['ISC_CFG']['BackupsAutomatic'] = 1;
	$GLOBALS['ISC_CFG']['BackupsAutomaticMethod'] = 'ftp';
	...
	$GLOBALS['ISC_CFG']['SystemLogging'] = 0;
	$GLOBALS['ISC_CFG']['HidePHPErrors'] = 1;
	$GLOBALS['ISC_CFG']['SystemLogTypes'] = 'general,payment,shipping,notification,accounting,emailintegration,ebay';
	$GLOBALS['ISC_CFG']['SystemLogSeverity'] = 'errors,warnings,success,notices';
	$GLOBALS['ISC_CFG']['SystemLogMaxLength'] = 0;
	$GLOBALS['ISC_CFG']['AdministratorLogging'] = 0;
  ...
  2 => 'Store Credit',
	...
	$GLOBALS['ISC_CFG']['AddonModules'] = 'addon_changeurlbywas33m,addon_permissioncheck,addon_facebookoptimizerbywas33m,addon_galleryeditorbywas33m,addon_orderxml,addon_ysm';
	...
	$GLOBALS['ISC_CFG']["EncryptionToken"] = '9cbb4d5d582ce05e8fe48b7fb538215a';
	...
	$GLOBALS['ISC_CFG']['GuestCustomerGroup'] = 1;
	$GLOBALS['ISC_CFG']['ForwardInvoiceEmails'] = 'cyclingwear@seightcustom.com.au';
  ...
  6 => 'storeComplete',
	...
	$GLOBALS['ISC_CFG']['ProductImagesStorewideThumbnail_timeChanged'] = 0;
	$GLOBALS['ISC_CFG']['ProductImagesProductPageImage_width'] = 220;
	$GLOBALS['ISC_CFG']['ProductImagesProductPageImage_height'] = 220;
	$GLOBALS['ISC_CFG']['ProductImagesProductPageImage_timeChanged'] = 0;
	...
	$GLOBALS['ISC_CFG']['ProductImagesTinyThumbnailsEnabled'] = 0;
	...
	$GLOBALS['ISC_CFG']["StartingOrderNumber"] = 184;
	...
	$GLOBALS['ISC_CFG']['taxChargesInCartBreakdown'] = 1;
	$GLOBALS['ISC_CFG']['taxDefaultCountry'] = 13;
	$GLOBALS['ISC_CFG']['taxDefaultState'] = 214;
  ...
  4 => 'android',
	...
	$GLOBALS['ISC_CFG']['FacebookLikeButtonEnabled'] = 1;
	...
	$GLOBALS['ISC_CFG']['FacebookLikeButtonAdminIds'] = '626585231';
	...
	// Slider
	$GLOBALS['ISC_CFG']['blockHeight'] = 450;
	$GLOBALS['ISC_CFG']['blockWidth'] = 960;
    $GLOBALS['ISC_CFG']['slider_skin'] = 'light-square';
    $GLOBALS['ISC_CFG']['slider_transition'] = 'fade';
	$GLOBALS['ISC_CFG']['sliderDir'] = 'images';
	
	//Socials
	$GLOBALS['ISC_CFG']['FacebookLink']='http://www.facebook.com/seightcustom';
	$GLOBALS['ISC_CFG']['TwitterLink'] = 'http://twitter.com/SeightCustom';
	$GLOBALS['ISC_CFG']['RssLink']='http://www.seightcustom.com.au/custom-cycling-clothing/Rss';
	//Contact info
	$GLOBALS['ISC_CFG']['ContactInfo']='<br/>Seight Custom Cycling Wear<br/><br/>
1 Barina Rd.(Cnr High St)<br/>
Glen Iris VIC 3146<br/>
Australia<br/><br/>
(03) 9886 0214 <br/>
0421 244 947 <br/><br/>
<a href="http://www.seightcustom.com.au/custom-cycling-clothing/Contact-Us" id="emaillink" >EMAIL NOW</a>';
	//gallery
	$GLOBALS['ISC_CFG']['galleryDir'] = 'seightgallery';
	
	//3 Modules background images
	$GLOBALS['ISC_CFG']['Module1Img']='images/3modules/news.jpg';
    $GLOBALS['ISC_CFG']['Module2Img']='images/3modules/featured.jpg';
	$GLOBALS['ISC_CFG']['Module3Img']='images/3modules/Img3.jpg';