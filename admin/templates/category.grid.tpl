			...
			<table class="GridPanel" cellspacing="0" cellpadding="0" border="0" style="width:100%;">
				<tr class="GridRow" onmouseover="this.className='GridRowOver'" onmouseout="this.className='GridRow'">
					...
					<td width="120" class="HideOnDrag">
						<a id="CatSitemap_{{ category.categoryid }}" title="{% lang 'ClickToHideCategorySitemap' %}" href="#" onclick="CategoryManager.toggleCategorySitemap({{ category.categoryid }});"><img border="0" src="images/{% if category.catsitemap %}tick.gif{% else %}cross.gif{% endif %}" alt="Sitemap"></a>
					</td>
					<td width="120" class="HideOnDrag">
