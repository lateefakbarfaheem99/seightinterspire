		...
		<form method="post" id="frmCategories" onSubmit="return false" action="index.php?ToDo=deleteCategory">
			<table class="GridPanel SortablePanel" cellspacing="0" cellpadding="0" border="0" style="width:100%; display: {{ DisplayGrid|safe }}">
				<tr class="Heading3">
					...
					<td width="120">
						<span onmouseover="ShowQuickHelp(this, '{% lang 'VisibleInSiteMap' %}', '{% lang 'CategorySitemapHelp' %}');" onmouseout="HideQuickHelp(this);" class="HelpText"><span class="NoWrap">{% lang 'VisibleInSiteMap' %}</span></span>
					</td>
					<td width="120">
