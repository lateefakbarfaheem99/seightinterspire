					...
					<div id="div_details" style="padding-top: 10px;">
					  <table class="Panel">
                        ...
                        <tr>
                            ...
                            <td>
                                <textarea rows="15" id="catcontent" name="catcontent" class="Field650 tinymce">{{ CategoryContent|safe }}</textarea>
                            </td>
                        </tr>
						<tr>
							<td class="FieldLabel">
                        ...
                        <tr>
                            <td class="FieldLabel">
                                &nbsp;&nbsp;&nbsp;{% lang 'PasswordProtect' %}:
                            </td>
                            <td>
                                <input type="checkbox" name="passwordprotect" id="passwordprotect" value="ON" {{ IsPasswordProtect|safe }} /> <label for="PasswordProtect">{% lang 'YesPasswordProtect' %}</label>
                                <img onmouseout="HideHelp('dpasswordprotect');" onmouseover="ShowHelp('dpasswordprotect', '{% lang 'PasswordProtect' %}', '{% lang 'PasswordProtectHelp' %}')" src="images/help.gif" width="24" height="16" border="0">
...
<script type="text/javascript">
	$.extend(lang, {
        ...
        PasswordRequire     : "{% jslang 'PasswordRequire' %}",
        PasswordMismatch     : "{% jslang 'PasswordMismatch' %}",
