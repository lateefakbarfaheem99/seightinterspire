	...
	// Slider
	$GLOBALS['ISC_CFG']['blockHeight'] = {{ blockHeight|safe }};
	$GLOBALS['ISC_CFG']['blockWidth'] = {{ blockWidth|safe }};
    $GLOBALS['ISC_CFG']['slider_skin'] = {{ slider_skin|safe }};
    $GLOBALS['ISC_CFG']['slider_transition'] = {{ slider_transition|safe }};
	$GLOBALS['ISC_CFG']['sliderDir'] = {{ sliderDir|safe  }};
	
	//Socials
	$GLOBALS['ISC_CFG']['FacebookLink']={{ FacebookLink|safe }};
	$GLOBALS['ISC_CFG']['TwitterLink'] = {{ TwitterLink|safe }};
	$GLOBALS['ISC_CFG']['RssLink']={{ RssLink |safe}};
	//Contact info
	$GLOBALS['ISC_CFG']['ContactInfo']={{ ContactInfo|safe}};
	//gallery
	$GLOBALS['ISC_CFG']['galleryDir'] = {{ galleryDir|safe  }};
	
	//3 Modules background images
	$GLOBALS['ISC_CFG']['Module1Img']={{ Module1Img|safe}};
    $GLOBALS['ISC_CFG']['Module2Img']={{ Module2Img|safe}};
	$GLOBALS['ISC_CFG']['Module3Img']={{ Module3Img|safe}};