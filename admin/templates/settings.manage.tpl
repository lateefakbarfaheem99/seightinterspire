	...
	<tr>
		<td>
			<ul id="tabnav">
				...
				<li><a href="#" id="tab9" onclick="ShowTab(9)">{% lang 'SliderSettingsTab' %}</a></li>
		...
		<td>
            ...
            <div id="div9" style="padding-top: 10px;">
                <table width="100%" class="Panel">
                    <tr>
                        <td class="Heading2" colspan="2">{% lang 'SliderSettings' %}</td>
                    </tr>

                    <tr>
                        <td class="FieldLabel">
                            &nbsp;&nbsp; <label for="BlockWidth">{% lang 'BlockWidth' %}:</label>
                        </td>
                        <td>
                            <input type="text" class="Field250" name="blockWidth" id="blockWidth" value="{{ blockWidth }}" />
                        
                        </td>
                    </tr>
                    <tr>
                        <td class="FieldLabel">
                            &nbsp;&nbsp; <label for="BlockHeight">{% lang 'BlockHeight' %}:</label>
                        </td>
                        <td>
                            <input type="text" class="Field250" name="blockHeight" id="blockHeight" value="{{ blockHeight }}" />
                        
                        </td>
                    </tr>
                    <tr>
                        <td class="FieldLabel">
                            &nbsp;&nbsp; <label for="slider_skin">{% lang 'Skin' %}:</label>
                        </td>
                        <td>
                            <select name="slider_skin" id="slider_skin">
                                <option value="default" {{ IsEnableSlider_DefaultSkin|safe }}>{% lang 'SliderSkin_Default' %}</option>
                                <option value="curved-rounded-2" {{ IsEnableSlider_CurvedRoundedSkin|safe }}>{% lang 'SliderSkin_CurvedRounded' %}</option>
                                <option value="curved-square" {{ IsEnableSlider_CurvedSquareSkin|safe }}>{% lang 'SliderSkin_CurvedSquare' %}</option>
                                <option value="light-round-extended" {{ IsEnableSlider_LightRoundExtendedSkin|safe }}>{% lang 'SliderSkin_LightRoundExtended' %}</option>
                                <option value="light-square" {{ IsEnableSlider_LightSquareSkin|safe }}>{% lang 'SliderSkin_LightSquare' %}</option>
                                <option value="minimal-small" {{ IsEnableSlider_MinimalSmallSkin|safe }}>{% lang 'SliderSkin_MinimalSmall' %}</option>
                                <option value="pixel" {{ IsEnableSlider_PixelSkin|safe }}>{% lang 'SliderSkin_Pixel' %}</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        <td class="FieldLabel">
                            &nbsp;&nbsp; <label for="slider_transition">{% lang 'SliderTransition' %}:</label>
                        </td>
                        <td>
                            <select name="slider_transition" id="slider_transition">
                                <option value="random" {{ IsEnableSlider_RandomTransition|safe }}>{% lang 'SliderTransition_Random' %}</option>
                                <option value="scale" {{ IsEnableSlider_ScaleTransition|safe }}>{% lang 'SliderTransition_Scale' %}</option>
                                <option value="fade" {{ IsEnableSlider_FadeTransition|safe }}>{% lang 'SliderTransition_Fade' %}</option>
                                <option value="slide" {{ IsEnableSlider_SlideTransition|safe }}>{% lang 'SliderTransition_Slide' %}</option>
                                <option value="width" {{ IsEnableSlider_WidthTransition|safe }}>{% lang 'SliderTransition_Width' %}</option>
                                <option value="height" {{ IsEnableSlider_HeightTransition|safe }}>{% lang 'SliderTransition_Height' %}</option>
                                <option value="simpleSlide" {{ IsEnableSlider_SimpleSlideTransition|safe }}>{% lang 'SliderTransition_SimpleSlide' %}</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                                <input type="text" name="sliderDir" value="{{ sliderDir|safe}}" class="Field">
                        </td>
			...
			<div id="div0" style="padding-top: 10px;">
                ...
                <tr>
                    <td class="Heading2" colspan="2">{% lang 'SocialsSettings' %}</td>
                </tr>
                <tr >
                    <td class="FieldLabel">
                        <label for="FacebookLink">{% lang 'FacebookLink' %}:</label>
                    </td>
                    <td>
                        <input type="text" name="FacebookLink" id="FacebookLink" value="{{ FacebookLink|safe }}" class="Field250" />
                    </td>
                </tr>
                <tr >
                    <td class="FieldLabel">
                        <label for="TwitterLink">{% lang 'TwitterLink' %}:</label>
                    </td>
                    <td>
                        <input type="text" name="TwitterLink" id="TwitterLink" value="{{ TwitterLink|safe }}" class="Field250" />
                    </td>
                </tr>
                <tr >
                    <td class="FieldLabel">
                        <label for="RssLink">{% lang 'RssLink' %}:</label>
                    </td>
                    <td>
                        <input type="text" name="RssLink" id="RssLink" value="{{ RssLink|safe }}" class="Field250" />
                    </td>
                </tr>
                <tr>
                    <td class="Heading2" colspan="2">{% lang 'ContactInfoSettings' %}</td>
                </tr>
				<tr >
                    <td class="FieldLabel">
                        <label for="ContactInfo">{% lang 'ContactInfo' %}:</label>
                    </td>
                    <td>
                        <textarea  name="ContactInfo" id="ContactInfo">{{ ContactInfo|safe }}</textarea>
                    </td>
                </tr>
                <tr>
                    <td class="Heading2" colspan="2">{% lang 'GallerySettings' %}</td>
                </tr>
                ...
                <tr>
                        ...
                        <td>
                                <input type="text" name="galleryDir" value="{{ galleryDir|safe}}" class="Field">
                        </td>
                        
                </tr>
                <tr>
                    <td class="Heading2" colspan="2">{% lang 'ThreeModulesSettings' %}</td>
                </tr>
                <tr>
                    <td class="FieldLabel">
                            &nbsp;&nbsp; <label for="Module1Img">{% lang 'Module1Image' %}:</label>
                        </td>
                        <td>
                            <input type="text" id="Module1Img" name="Module1Img" class="Field" value="{{ Module1Img|safe}}" />
                        </td>
                </tr>
                <tr>
                    <td class="FieldLabel">
                            &nbsp;&nbsp; <label for="Module2Img">{% lang 'Module2Image' %}:</label>
                        </td>
                        <td>
                            <input type="text" id="Module2Img" name="Module2Img" class="Field" value="{{ Module2Img|safe}}" />
                        </td>
                </tr>
                <tr>
                    <td class="FieldLabel">
                            &nbsp;&nbsp; <label for="Module3Img">{% lang 'Module3Image' %}:</label>
                        </td>
                        <td>
                            <input type="text" id="Module3Img" name="Module3Img" class="Field" value="{{ Module3Img|safe}}" />
                        </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <textarea name="SitemapContent" id="SitemapContent">{{SitemapContent|safe}}</textarea>
                    </td>
