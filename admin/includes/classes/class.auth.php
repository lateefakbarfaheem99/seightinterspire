<?php
    ...
    define("AUTH_Manage_Gallery_Images", 189);
	...
	class ISC_ADMIN_AUTH
	{
		...
		public function HandleSTSToDo($ToDo)
		{
            ...
            else if(is_numeric(isc_strpos($do, "gallery"))) {
                $GLOBALS['ISC_CLASS_ADMIN_FORMFIELDS'] = GetClass('ISC_ADMIN_GALLERYIMAGEMANAGER');
                $GLOBALS['ISC_CLASS_ADMIN_FORMFIELDS']->HandleToDo($ToDo);
            }
