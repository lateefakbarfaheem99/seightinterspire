		...
		public function setupHeader()
		{
			...
			if ($GLOBALS["ISC_CLASS_ADMIN_AUTH"]->IsLoggedIn() && !defined('IS_PHONE')) {
				...
				$menuItems = array(
                    ...
                    'mnuViewEmailMarketer' => array(
                        'link' => GetConfig('ShopPathNormal').'/emailmarketer/index.php' . $linkToken,
                        'target' => '_blank',
                        'text' => GetLang('ViewEmailMarketer')
                    ),
					'mnuHelp' => array(
			...
			$menuItems = array (
				...
				'mnuContent' => array (
					...
					'items' => array(
                        ...
                        array (
                            'id'   => 'SubMenuGalleryImageManager',
                            'text' => GetLang('GalleryImageManagerMenu'),
                            'help' => GetLang('GalleryImageManagerMenuIntro'),
                            'link' => 'index.php?ToDo=manageGalleryImages',
                            'show' => in_array(AUTH_Manage_Gallery_Images, $arrPermissions)
                        )
					),
				),
				'mnuMarketing' => array (
