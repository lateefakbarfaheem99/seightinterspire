<?php
	class ISC_ADMIN_SETTINGS extends ISC_ADMIN_BASE
	{
		public $all_vars = array (
			...
			'Feature_iContactModule',
			// Google Product Search
			'GoogleProductSearchCategoriesUrl',
			'GoogleTaxonomiesLastChecked',
			'GoogleTaxonomiesCheckedPeriod',
		    //Slider Settings
            'slider_skin',
            'slider_transition',
			'blockWidth',
		...
		private function SaveUpdatedSettings()
		{
			...
			$enums = array (
                ...
                'slider_skin'=> array('default','curved-rounded-2','curved-square','light-round-extended','light-square','minimal-small','pixel'),
                'slider_transition'=>array('random','scale','fade','slide','width','height','simpleSlide'),
			);
		...
		private function ManageSettings($messages=array())
		{
			...
			*/
            ...
            // slider pro
            if (GetConfig('slider_skin') == 'curved-rounded-2') {
                $GLOBALS['IsEnableSlider_CurvedRoundedSkin'] = "selected=\"selected\"";
            } else if (GetConfig('slider_skin') == 'curved-square') {
                $GLOBALS['IsEnableSlider_CurvedSquareSkin'] = "selected=\"selected\"";
            } else if (GetConfig('slider_skin') == 'light-round-extended') {
                $GLOBALS['IsEnableSlider_LightRoundExtendedSkin'] = "selected=\"selected\"";
            } else if (GetConfig('slider_skin') == 'light-square') {
                $GLOBALS['IsEnableSlider_LightSquareSkin'] = "selected=\"selected\"";
            } else if (GetConfig('slider_skin') == 'minimal-small') {
                $GLOBALS['IsEnableSlider_MinimalSmallSkin'] = "selected=\"selected\"";
            } else if (GetConfig('slider_skin') == 'pixel') {
                $GLOBALS['IsEnableSlider_PixelSkin'] = "selected=\"selected\"";
            } else {
                $GLOBALS['IsEnableSlider_DefaultSkin'] = "selected=\"selected\"";
            }           
            
            if (GetConfig('slider_transition') == "scale") {
                $GLOBALS['IsEnableSlider_ScaleTransition'] = "selected=\"selected\"";
            } else if (GetConfig('slider_transition') == "fade") {
                $GLOBALS['IsEnableSlider_FadeTransition'] = "selected=\"selected\"";
            } else if (GetConfig('slider_transition') == "slide") {
                $GLOBALS['IsEnableSlider_SlideTransition'] = "selected=\"selected\"";
            } else if (GetConfig('slider_transition') == "width") {
                $GLOBALS['IsEnableSlider_WidthTransition'] = "selected=\"selected\"";
            } else if (GetConfig('slider_transition') == "height") {
                $GLOBALS['IsEnableSlider_HeightTransition'] = "selected=\"selected\"";
            } else if (GetConfig('slider_transition') == "simpleSlide") {
                $GLOBALS['IsEnableSlider_SimpleSlideTransition'] = "selected=\"selected\"";
            } else {
                $GLOBALS['IsEnableSlider_RandomTransition'] = "selected=\"selected\"";
            } 			
