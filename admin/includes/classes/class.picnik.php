	...
	public function getSourceFileForImage($imageType, $imageId)
	{
		switch ($imageType) {
			...
			case ISC_PICNIK_TYPE_IMAGEMANAGER:
                ...
                return ISC_BASE_PATH . '/' . 'uploads' . '/' . rawurlencode($imageId);
				break;
		}
	}
	...
	public function getSourceUrlForImage($imageType, $imageId)
	{
		...
		switch ($imageType) {
			...
			case ISC_PICNIK_TYPE_IMAGEMANAGER:
                ...
                return GetConfig('ShopPathSSL') . '/' . 'uploads' . '/' . rawurlencode($imageId);
				break;
		}
	}
	...
	public function receivePicnik($token, $remoteFile)
	{
		...
		switch ($token['imagetype']) {
			...
			case ISC_PICNIK_TYPE_IMAGEMANAGER:
                ...
                $callbackData['url'] = GetConfig('ShopPathSSL') . '/' . 'uploads' . '/' . $callbackData['name'];
