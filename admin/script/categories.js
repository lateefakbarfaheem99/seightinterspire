var CategoryForm = {
	...
	checkForm : function()
	{
        ...
        var cpe = document.getElementById("passwordprotect");
        var cpass = document.getElementById("password");
        var crepass = document.getElementById("repassword");
        ...
        if(cpe.checked == true) {
            if (cpass.value == "") {
                alert(lang.PasswordRequire);
                cpass.focus();
                return false;
            } else if (cpass.value != crepass.value) {
                alert(lang.PasswordMismatch);
                cpass.focus();
                return false;                
            }
            /*if (cpass.value != "" && cpass.value != crepass.value) {
                alert(lang.PasswordMismatch);
                cpass.focus();
                return false;                
            }*/
