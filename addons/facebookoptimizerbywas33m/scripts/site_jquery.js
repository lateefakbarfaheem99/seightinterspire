...
$(document).ready(function(){
		...
		$("#contentLeft ul").sortable({ opacity: 0.6, cursor: 'move', update: function() {
			...
			if($('#table_name').val()){
				...
				$.post("?ToDo=runAddon&addon=addon_facebookoptimizerbywas33m&actionMode", order, function(response){
...
//						alert(response);
		...
		$(".visible").click(function(){
				...
				var Table	=	'isc_facebook_thumbnails';
				var Id			=	$(this).attr("id");
					
				$.post("?ToDo=runAddon&addon=addon_facebookoptimizerbywas33m&actionMode",{ 	Ajax	:	'toggle_visibility',
																							Table	:	Table,
																							Id		:	Id
