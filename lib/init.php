<?php
	...
	// The absolute filesystem root to Unreal Shopping Cart
	...
	// The minimum version of PHP required to run Unreal Shopping Cart
	define("PHP_VERSION_REQUIRED", "5.1.4");

	// The minimum version of MySQL required to run Unreal Shopping Cart
