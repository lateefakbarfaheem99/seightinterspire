...
/* galleries.manage.tpl */
class __TwigTemplate_5b8a5f04ea0d781ceecac831f026e622 extends Twig_Template
{
...
\t\t\t<p>";
        // line 9
        echo twig_safe_filter((isset($context['ManageGalleryIntro']) ? $context['ManageGalleryIntro'] : null));
        echo "</p>
\t\t\t";
        // line 10
...
\t\t\t\t<input type=\"button\" name=\"IndexAddButton\" value=\"";
        // line 14
        echo getLang("AddGallery");
        echo "...\" id=\"IndexCreateButton\" class=\"SmallButton\" onclick=\"document.location.href='index.php?ToDo=createGallery'\" /> &nbsp;
...
\t\t\t\t<table id=\"Table16\" style=\"display:";
        ...
        echo "\">
\t\t\t\t<tr>
\t\t\t\t\t<form action=\"index.php?ToDo=manageGalleryImages";
        // line 21
...
\t\t\t\t\t";
        // line 47
        echo twig_safe_filter((isset($context['GalleryDataGrid']) ? $context['GalleryDataGrid'] : null));
        echo "
\t\t\t\t</div>
\t\t\t</form>
\t\t</td></tr>
...
\t\t\t\tif(confirm(\"";
        // line 82
        echo getLang("ConfirmDeleteGallery");
        echo "\"))
