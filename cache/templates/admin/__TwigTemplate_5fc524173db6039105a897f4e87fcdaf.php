...
/* galleryimgman.view.tpl */
class __TwigTemplate_5fc524173db6039105a897f4e87fcdaf extends Twig_Template
{
...
\t\t\t\t\tupload_url: \"";
        ...
        echo "/admin/remote.php?remoteSection=galleryimagemanager&w=uploadimage&gal_name=";
        echo twig_safe_filter((isset($context['GalleryNameUrl']) ? $context['GalleryNameUrl'] : null));
        echo "\",\t// Relative to the SWF file or absolute
...
\t\t\t\t\t\taction: 'remote.php?remoteSection=galleryimagemanager&w=uploadimage&gal_name=";
        // line 97
        echo twig_safe_filter((isset($context['GalleryNameUrl']) ? $context['GalleryNameUrl'] : null));
        echo "&unique=' + global_randNum,
\t\t\t\t\t\ttitletext: '";
        // line 98
...
\t\t\t\t\t\$.post('remote.php?remoteSection=galleryimagemanager&w=delete&gal_name=";
        // line 170
        echo twig_safe_filter((isset($context['GalleryNameUrl']) ? $context['GalleryNameUrl'] : null));
        echo "', sendPOST,
\t\t\t\t\t\t\tfunction(json){
...
\t\trow += ' | <a id=\"%%image_id%%_download\" href=\"index.php?ToDo=downloadGalleryImage&gal_name=";
        // line 225
        echo twig_safe_filter((isset($context['GalleryNameUrl']) ? $context['GalleryNameUrl'] : null));
        echo "&image=%%image_realname%%\">";
...
\t\t\$.post('remote.php?remoteSection=galleryimagemanager&w=rename&gal_name=";
        // line 399
        echo twig_safe_filter((isset($context['GalleryNameUrl']) ? $context['GalleryNameUrl'] : null));
        echo "', 'fromName=' + escape(\$('#' + id + '_realname').val()) + '&toName=' + escape(newVal),
\t\t\tfunction(json){
\t\t\t\tvar result = \$.evalJSON(json);
\t\t\t\tif(result.success){
\t\t\t\t\tvar message = '";
...
\twindow.location = 'index.php?ToDo=uploadgalleryimages&page=' + pagenumber + '&id=";
        // line 434
        echo twig_safe_filter((isset($context['GalleryID']) ? $context['GalleryID'] : null));
        echo "&perpage='+ pagingamount;
}
...
\t\t<td class=\"Heading1\">";
        // line 449
        echo getLang("ManageGalleryImages");
        echo "</td>
\t</tr>
\t<tr>
\t\t<td class=\"Intro\">
...
\t\t<p>";
        // line 454
        echo getLang("ManageGalleryImagesIntro");
        echo "</p>
...
\t\t\t<input id=\"btnUpload\" type=\"button\" class=\"SmallButton\" value=\"";
        // line 462
        echo getLang("GalleryImageManagerUploadImages");
        echo "\" style=\"width: 130px;\" />&nbsp;<input id=\"deleteButton\" type=\"button\" value=\"";
        echo getLang("imageManagerDeleteSelected");
        echo "\"  class=\"SmallButton\"  style=\"display: \" />&nbsp;
            <input id=\"btnBack\" type=\"button\" class=\"SmallButton\" value=\"";
        // line 463
        echo getLang("GalleryImageManagerBack");
        echo "\" style=\"width: 150px;\" onclick=\"document.location.href='index.php?ToDo=manageGalleryImages'\"/>&nbsp;
